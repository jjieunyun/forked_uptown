        ...
        <div className="cInnerContent">
            ...
            <div className="cInnerContent_1" id='about_upcycling'>
                ...
                <div className="cInnerContent_1_right">
                    <img className="intro01"src="https://jjieunyun.github.io/uptown_demo/images/intro01(수정).PNG" alt='intro01'></img>
                </div>
            </div>
            ...
            <div className='about_page' id='about_upctown'>
                <div className='about_page_box_odd'>
                    ...
                    <img className='about_intro_img' src="https://jjieunyun.github.io/uptown_demo/images/ocean.jpg" alt='소개img1'></img>
                ...
                <div className='about_page_box_even'>
                    <img className='about_intro_img' src="https://jjieunyun.github.io/uptown_demo/images/forest.jpg" alt='소개img1'></img>
                    <div className='about_intro_card'>
                ...
                <div className='about_page_box_odd'>
                    <img className='about_intro_img' src="https://jjieunyun.github.io/uptown_demo/images/book_story.jpg" alt='소개img1'></img>
                    <div className='about_intro_card'>
                ...
                <div className='about_page_box_even'>
                    <img className='about_intro_img' src="https://jjieunyun.github.io/uptown_demo/images/frontImg3.jpg" alt='소개img1'></img>
                    <div className='about_intro_card'>
